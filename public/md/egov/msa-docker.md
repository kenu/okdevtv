...
docker run -d discovery

cd ../apigateway
./gradlew build -x test
docker build -t apigateway ./
docker run -d apigateway

cd ../board-service
./gradlew build -x test
docker build -t board-service ./
docker run -d board-service
