...
tar xvfz elasticsearch-7.15.1-linux-x86_64.tar.gz
...
ln -s kibana-7.15.1-linux-x86_64 kibana
cd kibana
```
...
tar xvfz logstash-7.15.1.tar.gz
...
tar xvfz filebeat-7.15.1-linux-x86_64.tar.gz
ln -s filebeat-7.15.1-linux-x86_64 filebeat
cd filebeat
```
