...
tar xvfz elasticsearch-7.4.0-linux-x86_64.tar.gz
...
tar xvfz kibana-7.4.0-linux-x86_64.tar.gz
...
tar xvfz logstash-7.4.0.tar.gz
...
tar xvfz filebeat-7.4.0-linux-x86_64.tar.gz
ln -s filebeat-7.4.0-linux-x86_64 filebeat
cd filebeat
