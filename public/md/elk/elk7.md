...
tar xvfz elasticsearch-7.6.1-linux-x86_64.tar.gz
...
tar xvfz kibana-7.6.1-linux-x86_64.tar.gz
...
tar xvfz logstash-7.6.1.tar.gz
ln -s logstash-7.6.1 logstash
cd logstash
```
...
tar xvfz filebeat-7.6.1-linux-x86_64.tar.gz
ln -s filebeat-7.6.1-linux-x86_64 filebeat
cd filebeat
