...
tar xfz elasticsearch-7.11.0-linux-x86_64.tar.gz
...
tar xfz kibana-7.11.0-linux-x86_64.tar.gz
...
tar xfz logstash-7.11.0-linux-x86_64.tar.gz
ln -s logstash-7.11.0-linux-x86_64 logstash
cd logstash
