...
tar xfz elasticsearch-7.15.0-linux-x86_64.tar.gz
...
tar xfz kibana-7.15.0-linux-x86_64.tar.gz
ln -s kibana-7.15.0-linux-x86_64 kibana
cd kibana
nohup bin/kibana &

cd ~/local
wget https://artifacts.elastic.co/downloads/logstash/logstash-7.15.0-linux-x86_64.tar.gz
tar xfz logstash-7.15.0-linux-x86_64.tar.gz
ln -s logstash-7.15.0 logstash
cd logstash
